...
set("n", "<A-e>a", function()	vim.diagnostic.open_float() end, { desc = "Show all errors in a floating window" })
--stylua: ignore end
...
-- Lua
set("v", "<leader><leader>x", ":lua<CR>", { desc = "Lua: Run selected lua code" })
